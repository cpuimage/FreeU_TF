...
class StableDiffusion(StableDiffusionBase):
    ...
    def __init__(
            ...
            img_width=512,
            jit_compile=False,
            active_free_u=True, b1=1.2, b2=1.4, s1=0.9, s2=0.2
    ):
        super().__init__(img_height, img_width, jit_compile)
        self.active_free_u = active_free_u
        self.b1 = b1
        self.b2 = b2
        self.s1 = s1
        self.s2 = s2
    ...
    def diffusion_model(self):
        ...
        if self._diffusion_model is None:
            self._diffusion_model = DiffusionModel(
                self.img_height, self.img_width, MAX_PROMPT_LENGTH, active_free_u=self.active_free_u, b1=self.b1,
                b2=self.b2, s1=self.s1, s2=self.s2
            )
            if self.jit_compile:
...
class StableDiffusionV2(StableDiffusionBase):
    ...
    def __init__(
            ...
            img_height=512,
            img_width=512,
            jit_compile=False, active_free_u=True, b1=1.1, b2=1.2, s1=0.9, s2=0.2,
    ):
        super().__init__(img_height, img_width, jit_compile)
        self.active_free_u = active_free_u
        self.b1 = b1
